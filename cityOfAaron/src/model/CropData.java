...
public class CropData implements Serializable {
    ...
    private int harvest;
    private int harvestAfterOfffering;
    ...
    public int getHarvestAfterOfffering() {
        return harvestAfterOfffering;
    }

    public void setHarvestAfterOfffering(int harvestAfterOfffering) {
        this.harvestAfterOfffering = harvestAfterOfffering;
    }
